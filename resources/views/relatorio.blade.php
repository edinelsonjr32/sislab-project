        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title ">Relatório de Reservas de Laboratórios do Periodo: {{date('d/m/y', strtotime($dataInicio))}} - {{date('d/m/y', strtotime($dataFim))}}</h4>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-12 text-right">
                    <button href"" onclick="window.print();" class="btn btn-sm btn-primary">{{ __('Imprimir') }}</button>
                  </div>
                </div>
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-success">
                <h4 class="card-title ">Relatório de Reservas de Equipamentos do Periodo: {{date('d/m/y', strtotime($dataInicio))}} - {{date('d/m/y', strtotime($dataFim))}}</h4>
