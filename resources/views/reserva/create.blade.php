                ...
                <div id="dataFimId">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input class="form-control{{ $errors->has('dataFim') ? ' is-invalid' : '' }}" name="dataFim" id="input-name" type="date" placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('dataFim') }}" required="true" aria-required="true"/>
