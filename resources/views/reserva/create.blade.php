                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('data') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('data') ? ' is-invalid' : '' }}"
                                            name="data" id="input-name" type="date" placeholder="{{ __('dd/mm/yyyy') }}"
                                            value="{{ old('data') }}" required="true" aria-required="true" />
                                        @if ($errors->has('data'))
                                        <span id="name-error" class="error text-danger"
                                            for="input-name">{{ $errors->first('data') }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('hora_inicio') ? ' has-danger' : '' }}">
                                        <input
                                            ...
                                            name="hora_inicio" id="input-name" type="time"
                                            placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('hora_inicio') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('hora_fim') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('hora_fim') ? ' is-invalid' : '' }}"
                                            name="hora_fim" id="input-name" type="time"
                                            placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('hora_fim') }}"
                                            required="true" aria-required="true" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <select class="form-control" data-style="btn btn-link" id="solicitante_id"
                                            name="solicitante_id">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('dataFim') ? ' has-danger' : '' }}">
                                            <input
                                                ...
                                                name="dataFim" id="input-name" type="date"
                                                placeholder="{{ __('dd/mm/yyyy') }}" value="{{ old('dataFim') }}" />
